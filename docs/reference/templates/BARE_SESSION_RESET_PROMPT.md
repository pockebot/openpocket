---
title: "BARE_SESSION_RESET_PROMPT.md Template"
summary: "Session startup reminder after /reset or new bare chat session"
read_when:
  - After chat memory reset
  - Before first action in a fresh session
---
