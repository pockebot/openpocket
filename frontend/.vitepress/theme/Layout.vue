...
function initScrollAnimations() {
  ...
  nextTick(() => {
    const targets = document.querySelectorAll(
      ".op-hero-left, .op-hero-right, .op-why, .op-why-item, .op-bento, .op-usecases, .op-workflow, .op-workflow-step, .op-integrations, .op-integration-card, .op-support, .op-support-item, .op-footer-animation"
    );
