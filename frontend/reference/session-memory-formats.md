...
All `workspace/` and `state/` paths on this page are relative to the **selected agent instance**.
In multi-agent installs, each agent has its own isolated copies of these files.
