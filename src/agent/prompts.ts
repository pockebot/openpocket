...
export function buildSystemPrompt(
  ...
  if (mode === "none") {
    return [
      ...
      "Device model: Agent Phone is the controlled Android device; Human Phone is the user's own phone used through Human Auth.",
      ...
      "If user says my camera/microphone/location/photos/album/files/payment data, treat it as Human Phone data and use request_human_auth.",
  ...
  if (mode === "minimal") {
    return [
      ...
      "- Device model: Agent Phone is the controlled Android target (emulator/physical phone/Android TV/cloud). Human Phone is the user's own phone reached via Human Auth.",
      "- If user says my camera/microphone/location/photos/album/files/payment data, default to Human Phone as the data source.",
      "- Do not use Agent Phone local personal data when user intent implies Human Phone ownership.",
      ...
      "- For complex/reusable auth UX, first create a JSON template via coding tools and pass templatePath in request_human_auth.",
  ...
  return [
    ...
    "- Agent Phone: the Android device you control (emulator/physical phone/Android TV/cloud).",
    "- Human Phone: the user's personal phone used for delegated data/authorization via Human Auth.",
    "- If the user says my camera/microphone/location/photos/album/files/payment data, treat it as Human Phone ownership by default.",
    "- Do not consume Agent Phone local personal data when intent indicates Human Phone data.",
    "",
    ...
    "- For reusable flows, generate template JSON with coding tools in workspace, then call request_human_auth with templatePath.",
